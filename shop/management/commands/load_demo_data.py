...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        products_data = [
            {'category': 'herramientas-manuales', 'name': 'Martillo carpintero 500g', 'slug': 'martillo-carpintero-500g', 'price': 8990, 'stock': 25, 'featured': True, 'description': 'Martillo de carpintero con mango de fibra de vidrio. Cabeza de acero forjado.'},
            ...
            {'category': 'herramientas-electricas', 'name': 'Taladro percutor 13mm 750W', 'slug': 'taladro-percutor-750w', 'price': 45990, 'stock': 10, 'featured': True, 'discount_price': 39990, 'description': 'Taladro percutor con mandril de 13mm. Motor de 750W. Velocidad variable.'},
            {'category': 'herramientas-electricas', 'name': 'Amoladora angular 4 1/2" 850W', 'slug': 'amoladora-angular-850w', 'price': 35990, 'stock': 12, 'featured': True, 'description': 'Amoladora angular con disco de 115mm. Motor de 850W.'},
            ...
            {'category': 'herramientas-electricas', 'name': 'Atornillador inalámbrico 12V', 'slug': 'atornillador-inalambrico-12v', 'price': 29990, 'stock': 20, 'discount_price': 25990, 'description': 'Atornillador a batería de litio 12V. Incluye 2 baterías y cargador.'},
            {'category': 'materiales-construccion', 'name': 'Cemento Portland 50kg', 'slug': 'cemento-portland-50kg', 'price': 7990, 'stock': 100, 'featured': True, 'description': 'Cemento Portland de alta resistencia. Bolsa de 50 kilos.'},
            ...
            {'category': 'pinturas-revestimientos', 'name': 'Pintura látex interior 20L', 'slug': 'pintura-latex-interior-20l', 'price': 32990, 'stock': 15, 'featured': True, 'discount_price': 28990, 'description': 'Pintura látex para interiores color blanco. Rendimiento: 10-12 m²/L.'},
            ...
            {'category': 'plomeria', 'name': 'Caño PVC 110mm x 4m', 'slug': 'cano-pvc-110mm-4m', 'price': 8990, 'stock': 30, 'featured': True, 'description': 'Caño de PVC para desagüe cloacal. Diámetro 110mm, largo 4 metros.'},
            {'category': 'plomeria', 'name': 'Grifería monocomando cocina', 'slug': 'griferia-monocomando-cocina', 'price': 24990, 'stock': 10, 'featured': True, 'discount_price': 21990, 'description': 'Grifería monocomando para cocina. Acabado cromado. Pico alto giratorio.'},
            {'category': 'electricidad', 'name': 'Cable unipolar 2.5mm² x 100m', 'slug': 'cable-unipolar-25mm-100m', 'price': 18990, 'stock': 20, 'featured': True, 'description': 'Cable unipolar de cobre 2.5mm². Rollo de 100 metros. Color celeste.'},
